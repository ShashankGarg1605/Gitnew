<template>
  <f7-page tabs no-page-content toolbar-fixed>
    <f7-navbar v-bind="$pzGlobalReactiveData.navHistory.length>1?{ 'back-link': 'back' }:''">
      ...
      <f7-nav-center>Communication Panel</f7-nav-center>
    </f7-navbar>
    <f7-toolbar tabbar>
          ...
          <f7-list accordion>
            <f7-list-item accordion-item title="Basic Details" v-if="userDetails">
              <f7-accordion-content>
                <f7-block>
                  ...
                  <list-item
                    :label="'Account since'"
                    :value="userDetails.created_date | dateFormat"
                  />
                  <list-item :label="'Mobile'">
                    <a
                      @click="$pzGlobalReactiveData.phone(userDetails.mobile)"
                    >{{userDetails.mobile}}</a>
                  </list-item>
                  <list-item :label="'2nd Mobile'">
                    <a
                      @click="$pzGlobalReactiveData.phone(userDetails.alternate_mobile)"
                    >{{userDetails.alternate_mobile}}</a>
                  </list-item>
                  ...
                  <list-item
                    :label="'Last app use'"
                    :value="userDetails.last_app_use | dateFormat"
                  />
                  <list-item :label="'App version'" :value="userDetails.app_version"/>
                  <list-item
                    :label="'Account type'"
                    :value="$pzGlobalReactiveData.accountTypeMap[userDetails.account_type]"
                  />
            ...
            <f7-list-item accordion-item title="Profile summary" v-if="userDetails">
              <f7-accordion-content>
                <f7-block>
                  <p
                    class="pz-bg-gray-lighter pz-border-radius-10 pz-padding-16"
                  >{{userDetails.profile_summary || '(Not available)'}}</p>
                </f7-block>
              </f7-accordion-content>
            </f7-list-item>
              ...
              <f7-accordion-content>
                <f7-block>
                  ...
                  <list-item :label="'Mgr mobile'">
                    <a
                      @click="$pzGlobalReactiveData.phone(userDetails.rm_mobile)"
                    >{{userDetails.rm_mobile}}</a>
                  </list-item>
                </f7-block>
              </f7-accordion-content>
            </f7-list-item>
            ...
            <f7-list-item accordion-item title="Business Details" v-if="userDetails">
              <f7-accordion-content>
                <f7-block>
                  ...
                  <list-item
                    :label="'Total Orders till date'"
                    :value="businessDetails && businessDetails.length"
                  />
                </f7-block>
              </f7-accordion-content>
            </f7-list-item>
              ...
              <f7-accordion-content>
                <f7-block>
                  <list-item
                    ...
                    :leftColWidth="60"
                    :rightColWidth="40"
                    v-if="userDetails.account_opening_form"
                  >
                    <span
                      class="button pz-bg-gray-lightest image pz-flex-sa-c pz-margin-r16"
                      style="float: left; margin-bottom: 10px;"
                      @click="openForm(userDetails.account_opening_form)"
                    >
                  ...
                  <list-item :label="'PAN card'" :leftColWidth="60" :rightColWidth="40">
                    <span
                      v-if="userDetails.pan_number && !userDetails.pan_image"
                    >{{userDetails.pan_number}}</span>
                    <span
                      class="button pz-bg-gray-lightest image pz-flex-sa-c pz-margin-r16"
                      style="float: left; margin-bottom: 10px;"
                      @click="openPhotoBrowser(userDetails.pan_image, 'pan', userDetails.pan_number)"
                      v-if="userDetails.pan_image"
                    >
                      <icon name="image"></icon>open
                    </span>
                  </list-item>
                  ...
                  <list-item :label="'Shop license number'" :leftColWidth="60" :rightColWidth="40">
                    <span
                      v-if="userDetails.shop_licence_number && !userDetails.shop_licence_image"
                    >{{userDetails.shop_licence_number}}</span>
                    <span
                      class="button pz-bg-gray-lightest image pz-flex-sa-c pz-margin-r16"
                      style="float: left; margin-bottom: 10px;"
                      @click="openPhotoBrowser(userDetails.shop_licence_image, 'shopLicense', userDetails.shop_licence_number)"
                      v-if="userDetails.shop_licence_image"
                    >
                      <icon name="image"></icon>open
                    </span>
                  </list-item>
            ...
            <f7-list-item accordion-item title="Logistics Details" v-if="userDetails">
              <f7-accordion-content>
                <f7-block>
                  <list-item
                    :label="'Goods carrier'"
                    :value="userDetails.carrier_info && userDetails.carrier_info.carrier && userDetails.carrier_info.carrier.name"
                  />
                  <list-item
                    :label="'Carrier mobile'"
                    v-if="userDetails.carrier_info && userDetails.carrier_info.carrier && userDetails.carrier_info.carrier.mobile"
                  >
                    <a
                      @click="$pzGlobalReactiveData.phone(userDetails.carrier_info.carrier.mobile)"
                    >{{userDetails.carrier_info.carrier.mobile}}</a>
                  </list-item>
                  <list-item
                    :label="'Avg duration of goods delivery'"
                    :value="userDetails.carrier_info && userDetails.carrier_info.transporting_days + ' days'"
                  />
              ...
              <f7-accordion-content>
                <f7-block>
                  <div v-if="registeredAddr" style="border: 1px dashed lightgrey;">
                    ...
                    <list-item
                      :label="'City (state)'"
                      :value="registeredAddr.city.name + ' (' + registeredAddr.city.state.name + ')'"
                    />
                  ...
                  <div v-if="shippingAddr" style="border: 1px dashed lightgrey; margin-top: 8px;">
                    ...
                    <list-item
                      :label="'City (state)'"
                      :value="shippingAddr.city.name + ' (' + shippingAddr.city.state.name + ')'"
                    />
            ...
            <f7-list-item accordion-item title="Return Details" v-if="returnDetails">
              <f7-accordion-content>
                <f7-block>
                  ...
                  <list-item
                    :label="'Total value till date'"
                    :value="returnDetails.reduce((sum,v)=>sum+v.approved_value, 0) | moneyFormat"
                  />
                </f7-block>
              </f7-accordion-content>
            </f7-list-item>
            ...
            >
              <f7-accordion-content>
                <f7-block>
                  ...
                  <list-item
                    v-if="chqBounceDetails"
                    :label="'No of cheque bounces'"
                    :value="chqBounceDetails.length"
                  />
                </f7-block>
              </f7-accordion-content>
            </f7-list-item>
            ...
            <f7-list-item
              accordion-item
              title="Buyer Discount Exceptions"
              v-if="userDiscountDetails"
            >
              <f7-accordion-content>
                <f7-block>
                  ...
                  <list-item
                    v-for="(d, index) in userDiscountDetails"
                    :key="index"
            ...
            <f7-list-item accordion-item title="Recent Service Requests " v-if="serviceRequests ">
              <f7-accordion-content>
                <f7-block>
                  <div
                    v-for="(sr, index) in serviceRequests "
                    :key="index "
                    class="message"
                    :class="{ 'pz-bg-gray-lightest': index%2==0} "
                  >
            ...
            <f7-list-item
              accordion-item
              title="Publisher Wise Sales (last 1 year) "
              v-if="publisherSales "
            >
              <f7-accordion-content>
                <f7-block>
                  <span class="color-gray pz-size-small">Only latest 10 results are shown</span>
                  <div
                    v-for="(o, index) in publisherSales "
                    :key="index "
                    class="message"
                    :class="{ 'pz-bg-gray-lightest': index%2==0} "
                  >
              ...
              <f7-accordion-content>
                <f7-block>
                  ...
                  <list-item
                    ...
                    :value="ageingDetails.availableCredit | moneyFormat"
                  />
                  <list-item
                    :label="'Total Over Due'"
                    :value="ageingDetails.overDue | moneyFormat"
                  />
                  <list-item
                    :label="'Amount Not Due'"
                    :value="ageingDetails.notDueAmt | moneyFormat"
                  />

                  <list-item
                    :label="'0 to 30 days'"
                    :value="ageingDetails.zeroToThirty | moneyFormat"
                  />
                  <list-item
                    :label="'30 to 60 days'"
                    :value="ageingDetails.thirtyToSixty | moneyFormat"
                  />
                  <list-item
                    :label="'60 to 90 days'"
                    :value="ageingDetails.sixtyToNinety | moneyFormat"
                  />
                  <list-item
                    :label="'90 to 120 days'"
                    :value="ageingDetails.ninetyToOnetwenty | moneyFormat"
                  />
                  <list-item
                    :label="'120 to 150 days'"
                    :value="ageingDetails.ontwentyToOnefifty | moneyFormat"
                  />
                  <list-item
                    :label="'150 to 180 days'"
                    :value="ageingDetails.onefiftyToOneeighty | moneyFormat"
                  />
                  <list-item
                    :label="'180 to 210 days'"
                    :value="ageingDetails.oneeightyToTwoten | moneyFormat"
                  />
                  <list-item
                    :label="'210 to 240 days'"
                    :value="ageingDetails.twotenToTwofourty | moneyFormat"
                  />
                  <list-item
                    :label="'240 to 270 days'"
                    :value="ageingDetails.twofourtyToTwoseventy | moneyFormat"
                  />
                  <list-item
                    :label="'270 to 300 days'"
                    :value="ageingDetails.TwoeventyToThreehundered | moneyFormat"
                  />
                  <list-item
                    :label="'300 to 330 days'"
                    :value="ageingDetails.threehunderedToThreethirty | moneyFormat"
                  />
                  <list-item
                    :label="'330 to 360 days'"
                    :value="ageingDetails.threethirtyToThreesixty | moneyFormat"
                  />
                  <list-item
                    :label="'Greater than 360'"
                    :value="ageingDetails.greaterThanThreesixty | moneyFormat"
                  />
                </f7-block>
              </f7-accordion-content>
            </f7-list-item>
            ...
            <f7-list-item
              ...
              @click="setCalenderInstance()"
              @accordion:closed="clearCalenderInstance()"
            >
              <f7-accordion-content>
                <f7-block>
                  <li class="item-content button pz-colr-inherit pz-cap" @click="openCalender()">
                    <div class="item-media">
                      <icon name="calendar-o"></icon>
                    </div>
                    <div class="item-inner pz-margin-l0">
                      <div
                        class="item-content pz-padding-l0 pz-size-normal text-container pz-width100"
                      >
...
export default {
  ...
  computed: {
    totalOrderValue() {
      if (!this.businessDetails || !this.businessDetails.length) return null;
        ...
        return this.businessDetails.reduce(
          (sum, _) => sum + _.finalOrderValue,
          0
        );
    },
    avgOrderValue() {
    ...
    registeredAddr() {
      if (!this.userDetails) return null;
        ...
        const address = this.userDetails.userAddress.find(
          _ => _.address_type === 1
        );
        return address || null;
      }
    ...
    shippingAddr() {
      if (!this.userDetails) return null;
        ...
        const shipAddress = this.userDetails.userAddress.find(
          _ => _.address_type === 2
        );
        const regAddress = this.userDetails.userAddress.find(
          _ => _.address_type === 1
        );
  ...
  methods: {
      ...
      this.autocompleteRef = window.vm.$f7.autocomplete({
        ...
        source(autocomplete, query, render) {
          ...
          for (var i = 0; i < that.users.length; i++) {
            if (
              that.users[i].name.toLowerCase().indexOf(query.toLowerCase()) >= 0
            )
              results.push(that.users[i]);
          }
    ...
    getReturnsData() {
      window.vm.$http
        .get(window._pz.apiEndPt + "returns?user=" + this.userID)
        .then(res => {
    ...
    getPaymentsData() {
      window.vm.$http
        .get(window._pz.apiEndPt + "users/payments/" + this.userID)
        .then(res => {
    ...
    getChqBounceData() {
      window.vm.$http
        .get(window._pz.apiEndPt + "payments/cheque_bounce?user=" + this.userID)
        .then(res => {
    ...
    getBusinessData() {
      window.vm.$http
        .get(window._pz.apiEndPt + "orders?userId=" + this.userID)
        .then(res => {
    ...
    getUserDiscountDetails() {
      window.vm.$http
        .get(window._pz.apiEndPt + "users/discounts/" + this.userID)
        .then(res => {
    ...
    getBuyerConversations() {
      window.vm.$http
        .get(window._pz.apiEndPt + "communication/" + this.userID)
        .then(res => {
    ...
    getServiceRequests() {
      window.vm.$http
        .get(window._pz.apiEndPt + "sr?user=" + this.userID)
        .then(res => {
    ...
    getPublisherSales() {
      ...
      window.vm.$http
        .get(
          `${
            window._pz.apiEndPt
          }reporting/sales/buyer_wise_publisher_wise?user=${
            this.userID
          }&startDate=${startDate}&toDate=${toDate}`
        )
        .then(res => {
    ...
    getAgeingDetails() {
      window.vm.$http
        .get(window._pz.apiEndPt + "utils/ageing/" + this.userID)
        .then(res => {
    ...
    downloadAccountStatement() {
      const startDate = window.vm
        .moment(this.compvalue[0])
        .format("YYYY-MM-DD");
      const endDate = window.vm.moment(this.compvalue[1]).format("YYYY-MM-DD");

      window.vm.$http
        .get(
          `${window._pz.apiEndPt}utils/collection_due/${
            this.userID
          }?view=detailed&startDate=${startDate}&endDate=${endDate}&pdf=true`
        )
        .then(res => {
          if (!res.ok) return;
          this.openExternalLink(res.body.link);
        });
    },
    ...
    openForm(filename) {
      ...
      }userdocs/accountopeningform/${filename}`;
      if (window._pz.checkNested(window, "cordova", "InAppBrowser"))
        window.cordova.InAppBrowser.open(url, "_system");
      else window.open(url, "_newtab");
    }
